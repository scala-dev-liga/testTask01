...
object STG1 {
  def executeLR(spark: SparkSession): Dataset[Row] = {
    ...
    val tableTime = datasetTelecommunication.withColumn("work/noWork",
    ...
    val summaryActivities = tableTime.groupBy("Square_id", "work/noWork")
      .agg(
    ...
    val activitiesStatistics: Dataset[Row] = summaryActivities.groupBy("Square_id", "work/noWork")
